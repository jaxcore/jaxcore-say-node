...
function playAudio(data, options, volume, callback) {
	// if (!SayNode.speaker) {
	// 	console.log('ERROR: npm speaker module not installed');
	// 	console.log('use:');
	// 	if (process.platform === 'darwin') console.log('npm install speaker --mpg123-backend=openal --no-save');
	// 	else console.log('npm install speaker');
	// 	process.exit();
	// }
...
class SayNode extends Jaxcore.Service {
